...
class EvilSonicDisplay:
    def __init__(self, assets_dir="/home/cm4/robot-project/src/assets/"):
        ...
        # Naudojame spidev tiesiogiai, nes luma neveikia
    ...
    def init_hw(self):
        ...
        print("[OK] ST7789 Valdiklis pažadintas.")
    ...
    def send_to_vram(self, pixel_bytes):
    ...
    async def animate(self):
        ...
        while True:
            ...
            if frames:
                ...
                await asyncio.to_thread(self.send_to_vram, data)
